       ...
       <div className="w-[500px] ">
        <div className="modal-box">
            ...
            <div className='mt-4 space-y-2'>
                ...
                <br/>
                <input type='text' placeholder='Enter you name' className='w-80 px-3 py-1 border rounded-md outline-none' {...register("name", { required: true })}/>
                <br />
                {errors.name && <span className='text-sm text-bold' >This field is required</span>}
            </div>
            <div className='mt-4 space-y-2'>
            ...
            <div className='mt-4 space-y-2'>
                ...
                <br/>
                <input type='text' placeholder='Enter you Password' className='w-80 px-3 py-1 border rounded-md outline-none' {...register("password", { required: true })}/>
                <br />
